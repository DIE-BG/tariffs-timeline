...
Search for all factual news published between August 25 and September 8, 2026,
...
or implemented by other countries in response to U.S.  tariffs.  Focus strictly
on factual information — exclude any editorial commentary or opinion.  Provide a
structured summary in English, preferably with tables listing the country, type
of action, affected goods, and date of the announcement.  Include official
actions and news form reputable sources.  Cover official government
announcements and actions, and reports from reputable news outlets about
potential or unofficial tariff developments.  I want the search to include both
U.S.  government actions and responses by foreign governments (retaliatory
tariffs, etc.).  Include actions or proposals even if they are not yet finalized
(e.g., draft proposals or threats).  I like the sources linked in the summary.
Focus only on tariffs directly involving the United States.  Include links to
official government sites and top-tier news outlets.

# General News Prompt

Busca en la web noticias publicadas entre el 1 de septiembre y el 8 de
septiembre de 2025, inclusive, para elaborar un resumen semanal dirigido a
